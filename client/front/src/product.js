class Product extends HTMLElement {
  ...
  async loadData () {
    this.product = {
      ...
      thumbnails: [
        {
          url: 'http://localhost:5175/public/call-of-duty-gameplay.jpg',
          alt: 'Call of Duty',
          cover: 'http://localhost:5175/public/call-of-duty-gameplay.jpg'
        },
        {
          url: 'http://localhost:5175/public/call-of-duty-gameplay-2.jpg',
          alt: 'Call of Duty',
          cover: 'http://localhost:5175/public/call-of-duty-gameplay-2.jpg'
        }
      ],
      video: {
        url: 'http://localhost:5175/public/call-of-duty.webm',
        alt: 'Call of Duty',
        cover: 'http://localhost:5175/public/call-of-duty-modern-warfare-3-xl.jpg'
      }
    }
  }
  ...
  render () {
    ...
    this.product.platforms.forEach(platform => {
      ...
      platformElement.src = `http://localhost:5175/public/${platform}.svg`
