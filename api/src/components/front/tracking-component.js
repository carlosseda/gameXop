...
class TrackingComponent extends HTMLElement {
  constructor () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // fetch(`${import.meta.env.VITE_process.env.API_URL}user-trackings`, {
      //   method: 'POST',
      //   headers: {
  ...
  generateFingerprint = () => {
    ...
    // fetch(`${import.meta.env.VITE_process.env.API_URL}fingerprints`, {
    //   method: 'POST',
    //   headers: {
    //     'Content-Type': 'application/json'
    //   },
  ...
  trackingScroll = () => {
    ...
    document.addEventListener('scroll', () => {
      ...
      scrollTimer = setTimeout(() => {
        ...
        fetch(`${process.env.API_URL}/api/front/user-trackings`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
